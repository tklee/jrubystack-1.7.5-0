...
#
apr_builddir=/bitnami/jrubystack-osx-x64/output/common/build-1
apr_builders=/bitnami/jrubystack-osx-x64/output/common/build-1
top_builddir=/bitnami/jrubystack-osx-x64/output/common/build-1
...
#
CFLAGS=-I/bitnami/jrubystack-osx-x64/output/common/include -arch x86_64
CPPFLAGS=-I/bitnami/jrubystack-osx-x64/output/common/include/sasl -I/bitnami/jrubystack-osx-x64/output/sqlite/include -I/bitnami/jrubystack-osx-x64/output/common/include -arch x86_64
LDFLAGS=-L/bitnami/jrubystack-osx-x64/output/sqlite/lib -L/bitnami/jrubystack-osx-x64/output/common/lib -arch x86_64
LIBS=
DEFS=-DHAVE_CONFIG_H
