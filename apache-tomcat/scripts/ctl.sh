...
CATALINA_HOME=/Applications/jrubystack-1.7.5-0/apache-tomcat
TOMCAT_BINDIR=/Applications/jrubystack-1.7.5-0/apache-tomcat/bin
JRE_HOME=/Applications/jrubystack-1.7.5-0/java
CATALINA_PID=/Applications/jrubystack-1.7.5-0/apache-tomcat/temp/catalina.pid
export CATALINA_PID
TOMCAT_STATUS=""
ERROR=0
PID=""
