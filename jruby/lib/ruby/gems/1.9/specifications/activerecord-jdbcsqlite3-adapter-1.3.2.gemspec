# -*- encoding: utf-8 -*-
# stub: activerecord-jdbcsqlite3-adapter 1.3.2 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<activerecord-jdbc-adapter>, ["~> 1.3.2"])
      s.add_runtime_dependency(%q<jdbc-sqlite3>, ["~> 3.7.2"])
    else
      s.add_dependency(%q<activerecord-jdbc-adapter>, ["~> 1.3.2"])
